        ...
        <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
            <div class="sidebar-sticky pt-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('branches.index') }}"><i data-feather="calendar"></i> Branch</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('employees.index') }}"><i data-feather="calendar"></i> Employee</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('agents.index') }}"><i data-feather="calendar"></i> Agent</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('universities.index') }}"><i data-feather="calendar"></i> University</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('courses.index') }}"><i data-feather="calendar"></i> Course</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('students.index') }}"><i data-feather="calendar"></i> Student</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('intakes.index') }}"><i data-feather="calendar"></i> Intake</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('application-years.index') }}"><i data-feather="calendar"></i> Application Year</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('application-status.index') }}"><i data-feather="calendar"></i> Application Status</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('student-applications.index') }}"><i data-feather="calendar"></i> Student Application</a>
                    </li>
