        ...
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('countries.create') }}" class="btn btn-primary btn-sm">
                    <i data-feather="plus" class="me-1" style="width: 14px; height: 14px;"></i> Add New Country
                </a>
            </div>
        </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover align-middle" id="countryTable">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center">No countries found. <a href="{{ route('countries.create') }}">Add a new country</a>.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
