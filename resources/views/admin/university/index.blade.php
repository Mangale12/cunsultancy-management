        ...
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <div>
                <a href="{{ route('universities.create') }}" class="btn btn-primary btn-sm">
                    <i data-feather="plus" class="me-1" style="width: 14px; height: 14px;"></i> Add University
                </a>
            </div>
        </div>
    <div class="card-body">
            ...
            <table class="table table-hover align-middle" id="universityTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>{{ $university->country->name }}</strong></td>
                        <td class="text-center">
                            <div class="btn-group">
                                <a href="{{ route('universities.edit', $university->id) }}" class="btn btn-sm btn-outline-primary">
                    ...
                    @empty
                    <tr>
                        <td colspan="4" class="text-center">No universities found. <a href="{{ route('universities.create') }}">Add a new university</a>.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
