...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-primary">Registered Branches</h6>
            <div>
                <a href="{{ route('branches.create') }}" class="btn btn-primary btn-sm">
                    <i data-feather="plus" class="me-1" style="width: 14px; height: 14px;"></i> Add Branch
                </a>
            </div>
        </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-hover align-middle" id="countryTable">
                ...
                <tbody>
                    ...
                    @empty
                    <tr>
                        <td colspan="3" class="text-center">No branches found. <a href="{{ route('branches.create') }}">Add a new branch</a>.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
