...
export default function StudentEdit({ student, branches, agents, courses, countries, states }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        country_id: student.country_id.toString(),
        state_id: student.state_id.toString(),
