...
import { ArrowLeft, Building, Phone, Mail, User, MapPin } from 'lucide-react';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Branch Details', href: '#' },
];

export default function BranchesShow({ branch }: Props) {
    return (
